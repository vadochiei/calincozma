                        ...
                        <div className="wpo-blog-content">
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link href="/blog-single/Letraset-Sheets-Passage-And-Recently">Election</Link></li>
                                        <li><Link href="/blog-single/Letraset-Sheets-Passage-And-Recently">Vote</Link></li>
                                        <li><Link href="/blog-single/Letraset-Sheets-Passage-And-Recently">Political</Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link href="/blog-single/Letraset-Sheets-Passage-And-Recently" target="_blank"><img src={blog6} alt="" /></Link>
                                </div>
